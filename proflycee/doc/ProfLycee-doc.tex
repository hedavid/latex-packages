...
% arara: lualatex: {shell: yes, synctex: no, interaction: nonstopmode}
%% arara: pythontex
...
\def\PLversion{4.00d}
\def\PLdate{15 février 2026}
\usepackage{amsfonts}
\usepackage[nonamssymb,warningsoff]{ProfLycee}
\useproflyclib{piton,pythontex,ecritures,espace}
%\useproflyclib{minted} %en test
...
\usepackage{hologo}
%patch \LaTeX ?
\DeclareRobustCommand{\LaTeX}{\hologo{LaTeX}\xspace}
...
\begin{PART}
	\begin{center}
		\Huge\MakeUppercase{Quelques cliparts}
	\end{center}
\end{PART}
\par\vfill\par\phantom{t}
...
\input{ProfLycee-doc-cliparts.tex}
