...
\tcbset{consolepyluatexlogo/.style={%avec logo python
  consolepylua,%
  overlay={%
    \draw ([yshift=0.5pt]frame.south) node[CouleurVertForet!50!black,fill=white,font=\scriptsize\ttfamily,inner ysep=1pt] {\scalebox{0.8}[0.8]{\pflfapython} \labelconsolepythonfin\ \scalebox{0.8}[0.8]{\pflfapython}} ;
    \draw ([yshift=-0.5pt]frame.north) node[CouleurVertForet!50!black,fill=white,font=\scriptsize\ttfamily,inner ysep=1pt] {\scalebox{0.8}[0.8]{\pflfapython} \labelconsolepythondebut\ \scalebox{0.8}[0.8]{\pflfapython}} ;
    }
  }
}
...
\tcbset{consolepyluatex/.style={%sans logo python
  consolepylua,%
  overlay={%
    \draw ([yshift=0.5pt]frame.south) node[CouleurVertForet!50!black,fill=white,font=\scriptsize\ttfamily,inner ysep=1pt] {\labelconsolepythonfin} ;
    \draw ([yshift=-0.5pt]frame.north) node[CouleurVertForet!50!black,fill=white,font=\scriptsize\ttfamily,inner ysep=1pt] {\labelconsolepythondebut} ;
    }
  }
}

\tcbset{consolepyluaalt/.style={%base de la boîte
  enhanced,colback=white,colframe=CouleurVertForet,rounded corners,arc=0.25\tmppitonconsoleheighttitles,boxrule=1pt,%
