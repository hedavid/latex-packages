...
{\small \bverb|v0.3.5|~:~~~~Ajout d'un style [Poker.v7]}

{\small \bverb|v0.3.4|~:~~~~Ajout d'un style [Poker.v6]}
...
\begin{itemize}
	...
	\item \cmaj{0.3.4} les cartes type \textsf{Poker v6} (Public Domain) \url{https://code.google.com/archive/p/vector-playing-cards}
	\item \cmaj{0.3.5} les cartes type \textsf{Poker v7} (Public Domain) \url{https://www.me.uk/cards/}
...
\AffCarteJeu[TypeJeu=Tarot]{10K}\AffCarteJeu[TypeJeu=Tarot]{null}%
\AffCarteJeu[TypeJeu=Tarot]{18AT}\\ \\
...
\begin{itemize}
	...
	\item \cmaj{0.3.5} la clé \Cle{Stylejeu} (parmi \Cle{v1}, \ldots, \Cle{v7}, \Cle{fr} ou \Cle{bicycl}) pour spécifier le style des cartes \textsf{Poker} ; \hfill{}défaut \Cle{v1}
...
\begin{itemize}
	...
	\item \Cle{v4} ;
	\item \Cle{v5} ;
	\item \Cle{v6} \cmaj{0.3.4} ;
	\item \Cle{v7} \cmaj{0.3.5} ;
...
\textbf{Design v6} :\\ \AffCartesJeu[Hauteur=2,StyleJeu=v6]{DK § AP § 10T § VP § 8T § RT § 9C} \hfill\cmaj{0.3.4}\\ \\
\textbf{Design v7} :\\ \AffCartesJeu[Hauteur=2,StyleJeu=v7]{DK § AP § 10T § VP § 8T § RT § 9C} \hfill\cmaj{0.3.5}\\ \\
...
\begin{codetex}[listing only]
%belote tri par couleur (P/C/T/K)
\JeuCompletBeloteTriCoul
%belote tri par hauteur (P/C/T/K)
...
\begin{codetex}[]
\MainCartesJeu[Hauteur=1.75,EspH=1.25]{\JeuCompletBeloteTriHaut}
\end{codetex}

\begin{codetex}[]
\MainCartesJeu[Hauteur=1.75,StyleJeu=v2,Eventail,Rotation=3.75,EspH=0.01,EspV=0.05]
    {\JeuCompletBeloteTriHaut}
\end{codetex}

\begin{codetex}[]
\MainCartesJeu[Hauteur=1.75,StyleJeu=bicycl,EspH=1]{\JeuCompletPokerTriCoul}
\end{codetex}
...
\begin{itemize}
	...
	\item \cmaj{0.3.5} la clé \Cle{Stylejeu} (parmi \Cle{v1}, \ldots, \Cle{v7}, \Cle{fr} ou \Cle{bicycl}) pour spécifier le style des cartes type \textsf{Poker/Belote/Rami/Bataille} ; \hfill{}défaut \Cle{v1}
	\item la clé \Cle{EspH} correspond à coefficient d'espacement horizontal (\textit{proche} du cm en taille réelle) entre les cartes ; \hfill{}défaut \Cle{1}
...
\textbf{\large Poker fr \& Poker v3 \& Poker v7:} \\ \\
\MainCartesJeuAleatoire[Hauteur=2.5,Eventail,EspH=0,EspV=0.1]{5} ou  \MainCartesJeuAleatoire[Hauteur=2.5,Eventail,EspH=0,EspV=0.1,StyleJeu=v3]{5} ou  \MainCartesJeuAleatoire[Hauteur=2.5,Eventail,EspH=0,EspV=0.1,StyleJeu=v7]{5}\\ \\
...
\subsection{Poker/Bataille/Belote/Rami (v6)}

Pas de dos disponible.

\medskip

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v6,Hauteur=1.85]{#1P}}

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v6,Hauteur=1.85]{#1C}}

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v6,Hauteur=1.85]{#1K}}

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v6,Hauteur=1.85]{#1T}}

\AffCarteJeu[StyleJeu=v6,Hauteur=1.85]{JN}\AffCarteJeu[StyleJeu=v6,Hauteur=1.85]{JR}%

\subsection{Poker/Bataille/Belote/Rami (v7)}

Dos disponibles : \texttt{Dos}

\medskip

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{#1P}}

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{#1C}}

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{#1K}}

\xintFor #1 in {2,3,4,5,6,7,8,9,10,V,D,R,A}\do{\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{#1T}}

\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{JN}\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{JR}\AffCarteJeu[StyleJeu=v7,Hauteur=1.85]{Dos}%
