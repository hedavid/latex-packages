...
\begin{center}
	...
	boite/.style={draw,rounded corners=4pt,minimum width=3cm,minimum height=1.2cm,
	...
	{\textbf{tkz-grapheur-calc.tex}\\{\footnotesize\color{gray}macros calculatoires}};
	\node[boite,fill=orange!15,draw=orange!60] (lua) at (6,-4)
