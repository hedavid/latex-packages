...
\title{The \textsf{lucide-icons} package (0.1.0) -- \today}
\author{%
	Cédric Pierquet\\%
	\url{https://lucide.dev} (Source version 0.534.0)\\%
...
\hspace*{5mm}\fbox{\begin{minipage}{0.75\linewidth}{\emph{A set of 1624 free ISC License high-quality SVG/PDF icons for you to use in your web projects.}}\end{minipage}}
...
\begin{document}
...
Inline \lucideicon{anchor} version
...
\end{document}
\end{Verbatim}

Result: Inline \lucideicon{anchor} version
