...
\begin{PresentationCode}{}
Inline Scrabble letter test positioning \ScrabbleWord{K} to see!
\end{PresentationCode}

\begin{PresentationCode}{}
Inline Scrabble word test positioning \ScrabbleWord{TE*ST} to see!
\end{PresentationCode}
...
\verb|v0.20a|:~~~~Bugfix with single letters
