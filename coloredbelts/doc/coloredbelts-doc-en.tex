...
\begin{itemize}[leftmargin=*]
	...
	\begin{itemize}
		\item can use an automatic height, with \MontreCode{auto} (95\,\% og the global height of current font, customizable with \MontreCode{Strut} key, + small vertical offset);
