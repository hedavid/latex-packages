...
\verb|v0.43a|:~~~New mathpictos

\verb|v0.42f|:~~~New box \textit{notebook}

\verb|v0.42e|:~~~Bugfix with \textsf{fa}

\verb|v0.42d|:~~~Enhancements + French keybord (see [fr] doc)

\verb|v0.42c|:~~~Enhancements + New icons + new mathpictos

\verb|v0.42b|:~~~New icons + new mathpictos
...
\subsection{Subpackage customenvs-tikzpictos (v0.20b)}
...
\subsection{Subpackage customenvs-icons (v0.1.5)}
...
\subsection{'Box' style number}

\begin{codehigh}[language=latex/latex2,style/main=teal!25,style/code=teal!25]
\tkzboxnumber[keys]{number}
...
\begin{demohigh}[language=latex/latex2,style/main=teal!25,style/code=teal!25]
%global style (for 'width auto' key)
\setKVdefault[TikzBoxNumber]{font=\cabincondensed\bfseries}
...
\subsection{'Box' notebook}

\begin{codehigh}[language=latex/latex2,style/main=teal!25,style/code=teal!25]
%box
\begin{tcboxnotebook}[keys]{tcbox options}
%...
\end{tcboxnotebook}

%---Available keys are:
% orientation = orientation of box (V)
% bar         = bar, within v mode (false)
% bg          = backgroud color (white)
\end{codehigh}
