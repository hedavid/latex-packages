...
\getvaluefromcycllist*{list}{index}
%extract value (cyclic list) and storing into macro (\myelt by default)
\getvaluefromcycllist{list}{index}[\macro]
\end{DemoCode}
...
\getvaluefromcycllist*{\listtmp}{10}\par\smallskip
%storing
\getvaluefromcycllist{\listtmp}{-10}[\myelt]\myelt
\end{DemoCode}
...
\getvaluefromcycldeflist(*){processed list, without \ !}{index}[\macro]
\end{DemoCode}
...
\getvaluefromcycldeflist*{mydeflist}{22}\\
...
\texttt{0.20b: Extract element with cyclic list}

\texttt{0.20a: Improvements in L3 version of package}

\texttt{0.1.7: Improvements in L3 version of package}

\texttt{0.1.6: L3 version of package}
