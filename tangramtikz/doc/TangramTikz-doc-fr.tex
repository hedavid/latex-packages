...
\begin{PresentationCode}{}
\TangramTikz<scale=0.75>{Renne}
\TangramTikz[Correction]<scale=0.75>{Renne}
\TangramTikz[CorrectionCouleur]<scale=0.75>{Renne}
\end{PresentationCode}

\begin{PresentationCode}{}
\TangramTikz<scale=0.75>{Cloche}
\TangramTikz[Correction]<scale=0.75>{Cloche}
\TangramTikz[CorrectionCouleur]<scale=0.75>{Cloche}
\end{PresentationCode}
