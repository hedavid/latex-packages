...
\begin{itemize}
	...
	\item la clé \Cle{Grille}, parmi \Cle{5x5 / Seyes / Ruled / Milli}, pour spécifier le type de quadrillage ;\hfill~défaut : \Cle{5x5}
...
\begin{itemize}
	...
	\item sous la forme \Cle{CouleurP/CouleurS/CouleurI} (\Cle{lightgray!66/lightgray!33/lightgray!50}) pour le Milli.
\end{itemize}
...
\begin{PresentationCode}{listing only}
%papiers millimétrés avec couleurs prédéfinies

\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilli>
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliGris>
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliBleu>
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliVert>
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliChaud>
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliContraste>
\end{PresentationCode}

\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilli>\par
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliGris>\par
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliBleu>\par
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliVert>\par
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliChaud>\par
\AffQuadrillage[Grille=Milli,NbCarreaux=9x2]<\CoulMilliContraste>
...
\verb|v0.1.9|~:~~~~Ajout des grilles \textsf{Milli}
