...
\DispGrid[Grid=Milli,NumSquares=9x2]<\ColMilli>
\DispGrid[Grid=Milli,NumSquares=9x2]<\ColMilliGray>
\DispGrid[Grid=Milli,NumSquares=9x2]<\ColMilliBlue>
\DispGrid[Grid=Milli,NumSquares=9x2]<\ColMilliWarm>
\DispGrid[Grid=Milli,NumSquares=9x2]<\ColMilliGreen>
\DispGrid[Grid=Milli,NumSquares=9x2]<\ColMilliContrast>
\end{PresentationCode}
